...
_C.ROBOSUITE.OBJECTS.CUBE_FRICTION = None # (Sliding, Torsional, Rolling) (0.5 to 1.2, 0.005, 0.0001)
_C.ROBOSUITE.OBJECTS.CUBE_DENSITY = None
_C.ROBOSUITE.OBJECTS.SPHERE_SCALE = 1.0
_C.ROBOSUITE.OBJECTS.SPHERE_FRICTION = None
_C.ROBOSUITE.OBJECTS.SPHERE_DENSITY = None
_C.ROBOSUITE.OBJECTS.CYLINDER_SCALE = 1.0
_C.ROBOSUITE.OBJECTS.CYLINDER_FRICTION = None
_C.ROBOSUITE.OBJECTS.CYLINDER_DENSITY = None
